...
void widgetOutPut::SetNumberOut(const int n)
{
     ...
     ui->lbl_Status->setText(tr("Saída %1 OFF").arg(QString::number(ui->lbl_out_num->text().toInt())));
}

/// ===========================================================================
///
/// ===========================================================================
void widgetOutPut::SetChecked(const bool n)
{
    ui->btn_exec->setChecked(false);
}
...
void widgetOutPut::on_btn_exec_toggled(bool checked)
{
    if(checked)
    {
        ui->lbl_Status->setText(tr("Saída %1 ON").arg(QString::number(ui->lbl_out_num->text().toInt())));
